...
import { Users, Mail, Phone, MapPin, Circle } from "lucide-react";
...
interface AboutContent {
  ...
  management?: { position: string; name: string; photo_url?: string | null }[];
  contact_phone?: string;
  contact_email?: string;
  contact_address?: string;
}

const AboutPreview: React.FC<{ content: AboutContent }> = ({ content }) => {
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">{content.history_text}</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                  <Card>
                    <CardContent className="pt-6">
                      <h2 className="text-2xl font-bold mb-4 text-primary">{content.vision_title}</h2>
              ...
              {content.mission_title && (
                ...
                >
                  <Card>
                    <CardContent className="pt-6">
                      <h2 className="text-2xl font-bold mb-4 text-primary">{content.mission_title}</h2>
                      <p className="text-muted-foreground whitespace-pre-line">{content.mission_text}</p>
                    </CardContent>
                  </Card>
                </motion.div>
              )}
